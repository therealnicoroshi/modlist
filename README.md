...
<td><a href="https://loadorderlibrary.com/lists/the-nico-experience-30">Load Order Library</a></td>
...
1. Install [Visual C++ x64](https://aka.ms/vs/16/release/vc_redist.x64.exe) & [.Net Runtime v8 desktop x64](https://dotnet.microsoft.com/en-us/download/dotnet/8.0/runtime).
...
8. Download and install [The Creation Kit from Steam](https://store.steampowered.com/app/1946180/Skyrim_Special_Edition_Creation_Kit/) **Start it once to allow it to generate needed files BUT DO NOT unpack the Data_Scripts.zip until AFTER installation is complete** Once it's open you can close it.
